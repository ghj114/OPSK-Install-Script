...
if [ $# -ne 2 ]; then echo "Usage: name path ..."; exit -1; fi
if [ ! -f $2 ] ; then echo "can not find the image"; exit 1; fi
...
glance add name=$1 is_public=true container_format=bare disk_format=raw < $2 
